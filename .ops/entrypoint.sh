...
envsubst < /usr/share/nginx/html/assets/env-vars/env-vars.sample.js > /usr/share/nginx/html/assets/env-vars/env-vars.js.tmp
mv /usr/share/nginx/html/assets/env-vars/env-vars.js.tmp /usr/share/nginx/html/assets/env-vars/env-vars.js
